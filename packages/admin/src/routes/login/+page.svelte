<script lang="ts">
  ...
  onMount(async () => {
    ...
    try {
      ...
      // OAuth providers endpoint unavailable — hide buttons
    }
  });
      ...
      {#if Object.values(oauthProviders).some(Boolean)}
        ...
        <div class="oauth-buttons">
          {#if oauthProviders.google}
            <a href="/api/admin/auth/oauth/google" class="btn btn-oauth">
          ...
          {#if oauthProviders.github}
            <a href="/api/admin/auth/oauth/github" class="btn btn-oauth">
          ...
          {#if oauthProviders.microsoft}
            <a href="/api/admin/auth/oauth/microsoft" class="btn btn-oauth">
              <svg class="oauth-icon" viewBox="0 0 24 24" width="18" height="18">
