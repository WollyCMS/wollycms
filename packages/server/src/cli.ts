  ...
  switch (command) {
    ...
    case 'types': {
      ...
      if (subcommand !== 'generate') {
        console.log('Usage: spacely types generate [--output <path>]');
        process.exit(1);
      }

      const outputIdx = process.argv.indexOf('--output');
      const outputPath = outputIdx > -1 ? process.argv[outputIdx + 1] : './spacely-types.d.ts';
      ...
      let output = `/**\n * Auto-generated by SpacelyCMS — do not edit manually.\n * Generated: ${new Date().toISOString()}\n */\n\n`;
      ...
      for (const ct of ctRows) {
        ...
        for (const r of regions) {
          output += `    ${r.name}?: import('@spacelycms/astro').ResolvedBlock[];\n`;
        }
        output += '  };\n';
      ...
      output += `export type SpacelyPage = ${pageUnion};\n\n`;
...
Examples:
  ...
  spacely types generate --output src/spacely-types.d.ts`);
      if (command) {
