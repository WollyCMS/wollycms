...
function readProcessEnv(): EnvConfig {
  ...
  return {
    ...
    GITHUB_REDIRECT_URI: p.GITHUB_REDIRECT_URI || '',
    GITHUB_AUTO_CREATE: p.GITHUB_AUTO_CREATE === 'true',
    MICROSOFT_CLIENT_ID: p.MICROSOFT_CLIENT_ID || '',
    MICROSOFT_CLIENT_SECRET: p.MICROSOFT_CLIENT_SECRET || '',
    MICROSOFT_REDIRECT_URI: p.MICROSOFT_REDIRECT_URI || '',
    MICROSOFT_AUTO_CREATE: p.MICROSOFT_AUTO_CREATE === 'true',
  };
}
...
export function initEnvFromBindings(bindings: Record<string, unknown>): void {
  ...
  env = {
    ...
    GITHUB_CLIENT_ID: b('GITHUB_CLIENT_ID'),
    GITHUB_CLIENT_SECRET: b('GITHUB_CLIENT_SECRET'),
    GITHUB_REDIRECT_URI: b('GITHUB_REDIRECT_URI'),
    GITHUB_AUTO_CREATE: b('GITHUB_AUTO_CREATE') === 'true',
    MICROSOFT_CLIENT_ID: b('MICROSOFT_CLIENT_ID'),
    MICROSOFT_CLIENT_SECRET: b('MICROSOFT_CLIENT_SECRET'),
    MICROSOFT_REDIRECT_URI: b('MICROSOFT_REDIRECT_URI'),
    MICROSOFT_AUTO_CREATE: b('MICROSOFT_AUTO_CREATE') === 'true',
  };
}
